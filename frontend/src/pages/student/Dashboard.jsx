...
function Sidebar({ activeTab, setActiveTab }) {
  ...
  const tabs = [
    ...
    { id: 'history', label: 'Performance Reports', icon: 'M9 19.5B4.5 4.5 0 007.5 15h-3a4.5 4.5 0 00-3 3.5M9 15h3M9 18h3m10.5-3.5h-3a4.5 4.5 0 00-3 3.5m6-3.5h3A4.5 4.5 0 0121 18.75m-6-3.75a3 3 0 11-6 0 3 3 0 016 0z' },
